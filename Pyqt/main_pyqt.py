...
from vdo_module import VdoModule, ChartsWindow
...
class Total(PicModule, VdoModule, CamModule, ReIDModule, ChartsWindow):
    def __init__(self):
    ...
    def closeEvent(self, a0: QtGui.QCloseEvent) -> None:
        ...
        event = QMessageBox.information(close_info, "关闭窗口", "确认退出？", QMessageBox.Yes | QMessageBox.No, QMessageBox.No)
